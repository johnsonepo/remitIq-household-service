...
class RemittancePolicyTest extends TestCase
{
    ...
    */
    ...
    public function test_owner_can_view_remittance(): void
    {
        ...
        $this->assertTrue($this->policy->view($user, $remittance));
    }
    ...
    public function test_non_owner_cannot_view_remittance(): void
    {
        ...
        $this->assertFalse($this->policy->view($user, $remittance));
    }
    ...
    public function test_household_membership_does_not_grant_view_access(): void
    {
        ...
        $this->assertFalse($this->policy->view($householdMember, $remittance));
    }
    ...
    */
    ...
    public function test_owner_can_update_remittance(): void
    {
        ...
        $this->assertTrue($this->policy->update($user, $remittance));
    }
    ...
    public function test_non_owner_cannot_update_remittance(): void
    {
        ...
        $this->assertFalse($this->policy->update($user, $remittance));
    }
    ...
    public function test_household_membership_does_not_grant_update_access(): void
    {
        ...
        $this->assertFalse($this->policy->update($householdMember, $remittance));
    }
    ...
    */
    ...
    public function test_owner_can_delete_remittance(): void
    {
        ...
        $this->assertTrue($this->policy->delete($user, $remittance));
    }
    ...
    public function test_non_owner_cannot_delete_remittance(): void
    {
        ...
        $this->assertFalse($this->policy->delete($user, $remittance));
    }
    ...
    public function test_household_membership_does_not_grant_delete_access(): void
    {
        ...
        $this->assertFalse($this->policy->delete($householdMember, $remittance));
    }
    ...
    */
    ...
    public function test_same_user_can_access_remittances_for_different_households(): void
    {
        ...
        $this->assertTrue($this->policy->view($user, $firstRemittance));

        $this->assertTrue($this->policy->view($user, $secondRemittance));

        $this->assertTrue($this->policy->update($user, $firstRemittance));

        $this->assertTrue($this->policy->update($user, $secondRemittance));

        $this->assertTrue($this->policy->delete($user, $firstRemittance));

        $this->assertTrue($this->policy->delete($user, $secondRemittance));
    }
    ...
    public function test_different_user_cannot_access_remittance_even_when_household_is_the_same(): void
    {
        ...
        $this->assertFalse($this->policy->view($otherUser, $remittance));

        $this->assertFalse($this->policy->update($otherUser, $remittance));

        $this->assertFalse($this->policy->delete($otherUser, $remittance));
    }
    ...
    */
    ...
    public function test_all_policy_actions_use_the_same_ownership_rule(): void
    {
        ...
        $this->assertTrue($this->policy->view($owner, $remittance));

        $this->assertTrue($this->policy->update($owner, $remittance));

        $this->assertTrue($this->policy->delete($owner, $remittance));
